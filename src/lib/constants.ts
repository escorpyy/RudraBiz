...
export const NAV_ITEMS: NavNode[] = [
  {
    ...
    children: [
      ...
      { label: "Product Group Master", href: "/master/product-groups" },
      { label: "Product Sub-Group Master", href: "/master/product-sub-groups" },
      { label: "Unit Master", href: "/master/units" },
      { label: "Tax Rate Master", href: "/master/tax-rates" },
      { label: "Stock Category Master", href: "/master/stock-categories" },
      { label: "Location Master", href: "/master/locations" },
